...
#    docker container exec corelight-softsensor /bin/bash -c 'mv /opt/zeek.yml /filebeat-8.6.0-linux-x86_64/modules.d/zeek.yml' &&
    ...
    docker container exec corelight-softsensor /bin/bash -c 'chmod go-w /filebeat-8.6.0-linux-x86_64/modules.d/zeek.yml' &&
    docker container exec corelight-softsensor /bin/bash -c 'chown root:root /filebeat-8.6.0-linux-x86_64/modules.d/zeek.yml' &&
